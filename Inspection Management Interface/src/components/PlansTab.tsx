      ...
      <div className="lg:col-span-3 space-y-4">
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              <Label>Characteristic Selection</Label>
              <div className="flex gap-2 mt-2">
                <Select defaultValue="length">
                  ...
                  <SelectContent>
                    <SelectItem value="length">Overall Length (Critical)</SelectItem>
                    <SelectItem value="width">Width Dimension (Significant)</SelectItem>
                    <SelectItem value="hole">Hole Diameter (Critical)</SelectItem>
                    <SelectItem value="surface">Surface Finish (Regular)</SelectItem>
                    <SelectItem value="thread">Thread Depth (Significant)</SelectItem>
                  </SelectContent>
                </Select>
                <Button size="sm" onClick={() => {
                  toast.success("Characteristic added to plan");
                  onChangeDetected();
                }}>
                  <Plus className="h-4 w-4 mr-1" />
                  Add
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                <Badge variant="outline" className="bg-red-50">Overall Length (C)</Badge>
                <Badge variant="outline" className="bg-amber-50">Width Dimension (S)</Badge>
                <Badge variant="outline">Surface Finish (R)</Badge>
              </div>
            </div>
          </div>
        </Card>
